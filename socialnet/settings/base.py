...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "SOCIALNET V2 ADMIN",
    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "SOCIALNET V2",
    ...
    "welcome_sign": "Welcome to the Socialnet v2 Admin Section",
    # Copyright on the footer
    "copyright": "Socialnet v2 Ltd",
    ...
    "usermenu_links": [
        {"name": "SOCIALNET V2 FrontPage", "url": FRONTEND_URL, "new_window": True},
        {"model": "accounts.user"},
    ],
    #############
    # Side Menu #
...
# TODO
# eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE3MDAzMTg5NjEsInVzZXJfaWQiOiIwYjEwMGZlMy1lODE2LTQ3MDAtYmFiYi1mZjI1NThmODY3ZDIiLCJ1c2VybmFtZSI6InRlc3QtYWRtaW4ifQ.oVmCZgAZov5tVRuFR6iRR0O6dcAZXoYHZ9SrbdyhZ9k
